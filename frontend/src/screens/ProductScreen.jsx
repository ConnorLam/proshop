...
function ProductScreen() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      toast.error(err?.data?.message || err.error || 'Review failed to be created');
    }
  };
  ...
  return (
    <>
      ...
      {/* EDIT REVIEW MODAL */}
      <Modal show={showEditModal} onHide={closeEditModalHandler} centered>
        ...
        <Form onSubmit={updateReviewHandler}>
          <Modal.Body>
            ...
            <Form.Group controlId="editRating" className="my-2">
              <Form.Label>Rating</Form.Label>

              <Form.Control as="select" value={editRating} onChange={(e) => setEditRating(Number(e.target.value))}>
                <option value={0}>Select...</option>
                <option value={1}>1 - Poor</option>
                <option value={2}>2 - Fair</option>
                <option value={3}>3 - Good</option>
            ...
            <Form.Group controlId="editComment" className="my-2">
              <Form.Label>Comment</Form.Label>
          ...
          <Modal.Footer>
            <Button type="button" variant="secondary" onClick={closeEditModalHandler}>
              Cancel
            </Button>

            <Button type="submit" variant="primary" disabled={loadingUpdateReview}>
              Update Review
            </Button>
          </Modal.Footer>
        </Form>
